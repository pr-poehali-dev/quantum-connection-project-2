...
const projects = [
  {
    ...
    location: "Светлые фасады · Матовая отделка",
    year: "2024",
    image: "/images/hously-1.png",
  },
  {
    id: 2,
    title: "Лофт в тёмных тонах",
    category: "Кухня на заказ",
    location: "Графит · Металлические акценты",
    year: "2024",
    image: "/images/hously-2.png",
  },
  {
    id: 3,
    title: "Классика в белом",
    category: "Кухня на заказ",
    location: "Белые фасады · Мрамор",
    year: "2023",
  ...
  },
  {
    ...
    location: "Открытая планировка · Остров",
    year: "2024",
